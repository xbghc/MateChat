  ...
  <div class="demo-test">
    ...
    <div v-else class="welcome-page">
      <McIntroduction
        logo-img="/logo2x.svg"
        title="MateChat"
        sub-title="Hi, welcome to MateChat"
        :description="[
          'MateChat can assist developers with coding, querying knowledge and related work information, writing documentation, etc.',
          'As an AI model, MateChat\'s answers may not always be definitive or accurate, but your feedback can help MateChat do better.',
        ]"
      ></McIntroduction>
      ...
      <div class="guess-question">
        <div class="guess-title">
          <div>Guess what you want to ask</div>
          <div>
    ...
    <div class="new-convo-button">
      ...
      <d-button icon="add" shape="circle" title="New Conversation" size="sm" @click="onNewConvo" />
    </div>
        ...
        <template #extra>
          <div class="input-foot-wrapper">
            ...
            <div class="input-foot-right">
              <d-button icon="op-clearup" shape="round" :disabled="!inputValue" @click="inputValue = ''">Clear Input</d-button>
            </div>
          </div>
        </template>
      </McInput>
...
const inputFootIcons = [
  ...
  { icon: 'icon-standard', text: 'Vocabulary' },
...
const getAIAnswer = (content) => {
  ...
  /* Simulate streaming data return */
  setTimeout(async () => {
